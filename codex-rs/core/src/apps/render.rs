...
pub(crate) fn render_apps_section() -> String {
    // TODO(ccunningham): Revisit whether apps guidance should keep this
    // XML-ish wrapper or use a plainer legacy format once developer-envelope
    // formatting is fully standardized.
    format!(
